...
# Both attributes and method names are returned (since methods are essentially attributes which are just callable)
print(dir(a))
...
# The optimistic approach (try/except) can actually be faster than hasattr(), which uses try/except internally anyway
